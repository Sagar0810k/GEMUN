...
export default function LearnMorePage() {
  ...
  const faqs = [
    {
      question: "Who can participate in CollegeMUN 2025?",
      answer:
        "CollegeMUN is open to undergraduate and graduate students from all academic backgrounds. No prior MUN experience is required, though we offer committees for all skill levels.",
    },
    {
      question: "What is the registration fee and what does it include?",
      answer:
        "Registration fee is $150 per delegate, which includes all conference materials, meals during the conference, welcome kit, certificate, and access to all social events.",
    },
    {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="scroll-fade-in text-center mb-16">
            ...
            <p className="font-serif text-xl text-muted-foreground max-w-3xl mx-auto">
              CollegeMUN offers more than just a conference experience - it's a transformative journey
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="scroll-fade-in text-center mb-16">
            ...
            <p className="font-serif text-xl text-muted-foreground max-w-3xl mx-auto">
              Your journey with CollegeMUN extends beyond the conference days
            </p>
          </div>
